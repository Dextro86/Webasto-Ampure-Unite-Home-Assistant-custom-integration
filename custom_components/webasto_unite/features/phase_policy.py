...
def evaluate_phase_policy(
    *,
    ...
    """Evaluate the Solar phase switching policy.

    This function never writes by itself. It reports the requested target and
    the phase action layer decides whether the target is stable enough to
    execute.
    """
