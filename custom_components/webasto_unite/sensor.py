...
SENSORS = (
    ...
    WebastoSensorDescription(key="phase_policy_stable_elapsed", name="Phase Policy Stable Time", value_key="phase_policy_stable_elapsed_s", native_unit_of_measurement=UnitOfTime.SECONDS, entity_category=EntityCategory.DIAGNOSTIC),
    WebastoSensorDescription(key="phase_policy_stable_required", name="Phase Policy Required Stable Time", value_key="phase_policy_stable_required_s", native_unit_of_measurement=UnitOfTime.SECONDS, entity_category=EntityCategory.DIAGNOSTIC),
    ...
    def _present_value(value, *, value_key: str | None = None):
        ...
        if isinstance(value, str):
            ...
            return {
                ...
                "waiting_for_stable_surplus": "Waiting For Stable Surplus",
