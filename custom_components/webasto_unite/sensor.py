...
SENSORS = (
    ...
    WebastoSensorDescription(key="charge_point_state_raw", name="Charge point state raw", value_key="charge_point_state_raw", entity_category=EntityCategory.DIAGNOSTIC),
    WebastoSensorDescription(key="charging_state_raw", name="Charging state raw", value_key="charge_state_raw", entity_category=EntityCategory.DIAGNOSTIC),
    WebastoSensorDescription(key="equipment_state_raw", name="Equipment state raw", value_key="evse_state_raw", entity_category=EntityCategory.DIAGNOSTIC),
