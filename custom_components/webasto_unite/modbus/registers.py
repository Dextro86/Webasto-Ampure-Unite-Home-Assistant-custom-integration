...
# Experimental 1P/3P phase-switch control register seen in Webasto/Vestel
# mappings and validated in field testing. Known values: 0 = 1P, 1 = 3P.
# Writes are exposed only through explicit manual/EVCC controls or the guarded
# Automatic Solar phase policy when that experimental mode is enabled.
