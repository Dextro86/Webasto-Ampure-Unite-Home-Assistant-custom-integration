...
- register `405` is exposed as the diagnostic `Phase switch mode code` sensor and as experimental phase-switch control; manual switching is blocked while charging is active
